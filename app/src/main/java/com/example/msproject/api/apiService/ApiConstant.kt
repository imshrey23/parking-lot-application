...
object ApiConstant {
    const val PARKING_LOTS_API = "https://658ytxfrod.execute-api.us-east-1.amazonaws.com/dev/parking_lots"
    const val PARKING_LOT_API = "http://10.0.2.2:8000/parkingLot/"
